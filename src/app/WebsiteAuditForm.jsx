        ...
        <div className='flex items-center justify-center'>
          ...
          ><div id="so-titleso1717549071">
            ...
            <div id="so-fieldswrapso1717549071">
                <input type="text" name="domain" id="so-domainso1717549071" 
                className="so-fieldso1717549071 " placeholder="Website URL" data-validation="Please enter a correct Website URL. Only homepages are accepted."/>
                <input type="text" name="first_name" id="so-first-nameso1717549071" className="so-fieldso1717549071" placeholder="First Name" data-validation="Please enter your First Name"/>
                  <input type="text" name="email" id="so-emailso1717549071" className="so-fieldso1717549071" placeholder="Email" data-validation="Please enter a valid email address."/>
                 ...
                 <div className='w-[100%]'>
                <input type="submit" className='w-full' id="so-submitso1717549071" value="Analyze"/>
                 </div>
                            </div>
        </form>
         </div>
