          ...
          <div id="so-boxso1717549071">
            <div id="so-titleso1717549071">
              <div className="flex justify-between items-center">
                ...
                <RiCloseLargeFill
                  className="absolute top-2 right-5 text-white cursor-pointer  rounded-full text-xl"
            ...
            >
              ...
              <div id="so-fieldswrapso1717549071">
                <input
                  type="text"
                  name="domain"
                  id="so-domainso1717549071"
                  className="so-fieldso1717549071"
                ...
                <input
                  ...
                  className="so-fieldso1717549071 w-full"
                ...
                <input
                  type="text"
                  name="phone"
                  id="so-phoneso1717549071"
                  className="so-fieldso1717549071"
                  placeholder="Phone Number"
                  data-validation="Please enter your phone"
                />
                <input
                  type="submit"
                  id="so-submitso1717549071"
                  value="Analyze"
                  className="bg-black"
