  ...
  function closeSoModal() {
    ...
    <div id="so-boxso1717549071">
                    <div id="so-titleso1717549071">
                      ...
                      <RiCloseLargeFill className='absolute top-2 right-5 text-white cursor-pointer  rounded-full text-xl' onClick={() => setShowModal(false)} />
            ...
            <input type="hidden" name="uid" value="63716"/>
            <input type="hidden" name="behaviour" value="modal"/>
            <input type="hidden" name="template" value="0"/>

                        
            <div id="so-fieldswrapso1717549071">
                <input type="text" name="domain" id="so-domainso1717549071" className="so-fieldso1717549071" placeholder="Website URL" data-validation="Please enter a correct Website URL. Only homepages are accepted."/>
                                    <input type="text"
                                     name="first_name" 
                                     id="so-first-nameso1717549071" 
                                     className="so-fieldso1717549071 w-full" placeholder="First Name" data-validation="Please enter your First Name"/>
                                                                    
                                                                    <input 
                                                                    type="text" 
                                                                    name="email" 
                                                                    id="so-emailso1717549071" 
                                                                    className="w-full so-fieldso1717549071" 
                                                                    placeholder="Email" data-validation="Please enter a valid email address."/>
                                                    <input type="text" name="phone" id="so-phoneso1717549071" className="so-fieldso1717549071" placeholder="Phone Number" data-validation="Please enter your phone"/>
                                                <input type="submit" id="so-submitso1717549071" value="Analyze" className='bg-black' style={{width: "100%", backgroundColor:'black'}}/>
                            </div>
        </form>
    </div>
</div>
